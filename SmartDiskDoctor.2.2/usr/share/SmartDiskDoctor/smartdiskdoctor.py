...
class AboutDialog(QDialog):
    ...
    def init_ui(self):
        ...
        title_label = QLabel(lang.get("General", "AppName", "Smart Disk Doctor v2.0.2"))
        ...
        details = [
            f"<b>{lang.get('About', 'Version', 'Sürüm')}:</b> 2.0.2",
...
class ZeusHDDDoctor(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(lang.get("General", "AppName", "Smart Disk Doctor v2.0.2"))
